  ...
  async.parallel(
    ...
    (err, results) => {
      ...
      if (results.genres_books > 0) {
        //Genres has books. Hence render form as you did in Get
        res.render("genre_delete", {
          title: "Delete Genre",
          genre: results.genre,
          genre_books: results.genres_books,
...
exports.genre_update_post = [
  ...
  (req, res, next) => {
    ...
    //create new genre with escaped & trimmed and old id
    ...
    if (!errors.isEmpty()) {
      //There are errors, hence rerender form with sanitized values and errors messages
      res.render("genre_form", {
        title: "Update form",
        genre,
        errors: errors.array(),
    ...
    //The entered data is valid. update the record
    Genre.findByIdAndUpdate(req.params.id, genre, {}, (err, thegenre) => {
      if (err) {
        return next(err);
      }
      //Success: redirect genre detail page
